...
pub(crate) mod edge_tests {
    use crate::{core::edge::{Edge, EdgeId, EdgeMap, NodeId}, utils::new_trait::ENew};

    pub fn get_3_default_edge_map<E: Edge + ENew>() -> EdgeMap<E> {
    ...
    pub fn get_example_default_edge_map<E: Edge + ENew>() -> EdgeMap<E> {
        let mut edge_map = EdgeMap::<E>::new();
        for _ in 0..5 {
            edge_map.add(E::default());
        }
    ...
    pub fn get_example_non_default_edge_map<E: Edge + ENew>() -> EdgeMap<E> {
        let mut edge_map = EdgeMap::<E>::new();
    ...
    pub fn test_add_helper<E: Edge + ENew>() {
        let mut edge_map = EdgeMap::<E>::new();
    ...
    pub fn test_add_from_nodes_helper<E: Edge  + ENew>() {
        let mut edge_map = EdgeMap::<E>::new();
    ...
    pub fn test_remove_edges_dependent_on_node_helper<E: Edge + ENew>() {
    ...
    pub fn test_insert_helper<E: Edge + ENew>() {
